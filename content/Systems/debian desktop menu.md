`$XDG_CONFIG_DIRS/menus/${XDG_MENU_PREFIX}applications.menu`2


# debian gnome desktop menu

source: [Desktop Menu Specification](https://specifications.freedesktop.org/menu-spec/latest/index.html)
...
> [!note]+ mystuff.menu
>
>```xml title="Systems/Code_files/mystuff.menu"
...
>   <!-- mystuff submenu -->
>   <Menu>
>     <Name>0-My Stuff</Name>
>     <Directory>mystuff.directory</Directory>
>     <Include>
>       <And>
